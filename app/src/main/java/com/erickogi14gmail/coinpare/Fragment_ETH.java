...
public class Fragment_ETH extends Fragment {
    private View view;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view=inflater.inflate(R.layout.fragment_eth,container,false);
        ...
        swipeRefreshLayout.setOnRefreshListener(() -> {
            ...
            model.getETH().observe(this,pojos -> {
        ...
        model.getETH().observe(this, pojo-> {

            adapter=new CurrencyListAdapter(getContext(), pojo, (postion, foldingCell) -> {
